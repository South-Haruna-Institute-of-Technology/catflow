...
mod == (HMODULE)cheat_module ? xor_c("CATFLOW") : module_name, bytes,
...
namespace cheat
{
	...
	void initialize()
	{
...
#if debug_log_create
		file_stream.open(xor_c("catflow_inject.txt"), std::ios::binary);
		...
		debug_log((" ######     ###    ######## ######## ##        #######  ##      ## \n##    ##   ## ##      ##    ##       ##       ##     ## ##  ##  ##\n##        ##   ##     ##    ##       ##       ##     ## ##  ##  ##\n##       ##     ##    ##    ######   ##       ##     ## ##  ##  ##\n##       #########    ##    ##       ##       ##     ## ##  ##  ##\n##    ## ##     ##    ##    ##       ##       ##     ## ##  ##  ##\n ######  ##     ##    ##    ##       ########  #######   ###  ###  "));
		interfaces::engine->execute_cmd_unrestricted("echo ");
		interfaces::engine->execute_cmd_unrestricted("echo .######.....###....########.########.##........#######..##......## ");
		interfaces::engine->execute_cmd_unrestricted("echo ##....##...##.##......##....##.......##.......##.....##.##..##..## ");
		interfaces::engine->execute_cmd_unrestricted("echo ##........##...##.....##....##.......##.......##.....##.##..##..## ");
		interfaces::engine->execute_cmd_unrestricted("echo ##.......##.....##....##....######...##.......##.....##.##..##..## ");
